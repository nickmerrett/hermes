"""Yahoo Finance news collector using Playwright web scraping"""
...
class YahooFinanceNewsCollector(BaseCollector):
    ...
    Note: This collector does NOT collect stock prices or market data,
    only news articles related to the company's stock symbol.
    """
    ...
    def __init__(self, customer_config: Dict[str, Any]):
        ...
        self.cache_dir = Path("data/cache/yahoo_finance")
    ...
    async def _collect_news(self) -> List[IntelligenceItemCreate]:
        ...
        try:
            ...
            # Don't raise - return empty list so collection can continue
        except Exception as e:
